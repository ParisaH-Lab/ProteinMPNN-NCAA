...
#SBATCH --job-name=sample_training_sbatch                    #Job Name
#SBATCH --output=sample_training_output                    #File to store output
#SBATCH --error=sample_training_output_error                    #File to store error messages
