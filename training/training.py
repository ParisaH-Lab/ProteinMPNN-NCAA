...
def main(args):
    ...
    vanilla_train_weights = torch.load("/projects/parisahlab/lmjone/internship/ProteinMPNN-PH/training/outputs/vanilla_sample_training_output/model_weights/epoch200_step564.pt", map_location=device)
    dchiral_train_weights = torch.load("/projects/parisahlab/lmjone/internship/ProteinMPNN-PH/training/outputs/mirrored_sample_training_output/model_weights/epoch200_step606.pt", map_location=device)
