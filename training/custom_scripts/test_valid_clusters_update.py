...
input_test_clusters = '/projects/parisahlab/lmjone/internship/ProteinMPNN-PH/training/datasets/combined_labeled_pdb_2021aug02_sample/test_clusters.txt'
output_test_clusters_mirror = '/projects/parisahlab/lmjone/internship/ProteinMPNN-PH/training/datasets/combined_labeled_pdb_2021aug02_sample/test_clusters_mirror.txt'

# Paths to the original and mirrored validation cluster files
input_valid_clusters = '/projects/parisahlab/lmjone/internship/ProteinMPNN-PH/training/datasets/combined_labeled_pdb_2021aug02_sample/valid_clusters.txt'
output_valid_clusters_mirror = '/projects/parisahlab/lmjone/internship/ProteinMPNN-PH/training/datasets/combined_labeled_pdb_2021aug02_sample/valid_clusters_mirror.txt'
