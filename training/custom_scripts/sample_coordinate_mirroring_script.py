...
input_directory = '/projects/bgmp/lmjone/internship/ProteinMPNN-PH/training/datasets/pdb_2021aug02/pdb'
...
for filename in os.listdir(input_directory):
    ...
    if filename.endswith('.pt'):
        ...
        if 'xyz' in data:
            ...
            # Notify when each file is processed and saved.
            print(f"Mirrored coordinates saved to {output_filename}")

# Notify when the script is done running.
