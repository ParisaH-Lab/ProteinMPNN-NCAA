...
python training.py --path_for_training_data /projects/bgmp/lmjone/internship/ProteinMPNN-PH/training/mirrored_pdb_2021aug02_sample --path_for_outputs /projects/bgmp/lmjone/internship/ProteinMPNN-PH/training/mirrored_sample_training_output
